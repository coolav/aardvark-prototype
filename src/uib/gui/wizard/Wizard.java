...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    public static final String CANCEL_BUTTON_ACTION_COMMAND = "CancelButtonActionCommand";
     /**
      * Creates a private instance of parent frame AardvarkGui
      * 
      */
   ...
   /**
    ...
    private void initComponents() {
        ...
        backButton = new JButton(new ImageIcon("uib/gui/wizard/backIcon.gif"));
        ...
        final int x = (screenSize.width - wizardDialog.getWidth()) / 1;
        final int y = (screenSize.height - wizardDialog.getHeight()) / 1;
        wizardDialog.setLocation(x, y);
        //Dimension ss = Toolkit.getDefaultToolkit().getScreenSize();
        //wizardDialog.setLocation((ss.width - wizardDialog.getWidth()) >> 1, (ss.height - wizardDialog.getHeight()) >> 1);
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("uib.gui.wizard.Wizard");
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                    ResourceBundle.getBundle("uib.gui.wizard.wizard");
